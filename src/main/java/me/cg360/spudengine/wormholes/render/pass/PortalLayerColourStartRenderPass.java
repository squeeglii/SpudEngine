...
public class PortalLayerColourStartRenderPass extends SwapChainRenderPass {

    public PortalLayerColourStartRenderPass(SwapChain swapChain, int depthImageFormat) {
